...
init_help_array(void)
{
  ...
  cluster_args_info_help[19] = 0; 
  
}

const char *cluster_args_info_help[20];
...
void init_args_info(struct cluster_args_info *args_info)
{
  ...
  args_info->debug_help = cluster_args_info_full_help[18] ;
  args_info->config_dir_help = cluster_args_info_full_help[19] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVNMR:FIGXd:k:bDc:", long_options, &option_index);
