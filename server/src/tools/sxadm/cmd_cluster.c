...
init_help_array(void)
{
  ...
  cluster_args_info_help[16] = 0; 
  
}

const char *cluster_args_info_help[17];
...
void init_args_info(struct cluster_args_info *args_info)
{
  ...
  args_info->batch_mode_help = cluster_args_info_full_help[14] ;
  args_info->debug_help = cluster_args_info_full_help[15] ;
  args_info->config_dir_help = cluster_args_info_full_help[16] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVNMIGd:k:bDc:", long_options, &option_index);
