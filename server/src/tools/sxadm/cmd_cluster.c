...
void init_args_info(struct cluster_args_info *args_info)
{
  ...
  args_info->port_help = cluster_args_info_help[10] ;
  args_info->ssl_ca_file_help = cluster_args_info_help[11] ;
  args_info->config_dir_help = cluster_args_info_help[13] ;
  args_info->batch_mode_help = cluster_args_info_help[14] ;
  args_info->debug_help = cluster_args_info_help[15] ;
