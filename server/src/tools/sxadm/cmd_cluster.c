...
init_help_array(void)
{
  ...
  cluster_args_info_help[17] = 0; 
  
}

const char *cluster_args_info_help[18];
...
void init_args_info(struct cluster_args_info *args_info)
{
  ...
  args_info->info_help = cluster_args_info_full_help[6] ;
  args_info->force_gc_help = cluster_args_info_full_help[7] ;
  args_info->force_expire_help = cluster_args_info_full_help[8] ;
  args_info->node_dir_help = cluster_args_info_full_help[10] ;
  args_info->port_help = cluster_args_info_full_help[11] ;
  args_info->ssl_ca_file_help = cluster_args_info_full_help[12] ;
  args_info->admin_key_help = cluster_args_info_full_help[13] ;
  args_info->batch_mode_help = cluster_args_info_full_help[15] ;
  args_info->debug_help = cluster_args_info_full_help[16] ;
  args_info->config_dir_help = cluster_args_info_full_help[17] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVNMIGXd:k:bDc:", long_options, &option_index);
