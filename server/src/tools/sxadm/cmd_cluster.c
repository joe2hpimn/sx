...
init_help_array(void)
{
  ...
  cluster_args_info_help[25] = cluster_args_info_full_help[29];
  cluster_args_info_help[26] = 0; 
  
}

const char *cluster_args_info_help[27];
...
void init_args_info(struct cluster_args_info *args_info)
{
  ...
  args_info->upgrade_help = cluster_args_info_full_help[16] ;
  args_info->node_dir_help = cluster_args_info_full_help[18] ;
  args_info->port_help = cluster_args_info_full_help[19] ;
  args_info->ssl_ca_file_help = cluster_args_info_full_help[20] ;
  args_info->admin_key_help = cluster_args_info_full_help[21] ;
  args_info->batch_mode_help = cluster_args_info_full_help[23] ;
  args_info->human_readable_help = cluster_args_info_full_help[24] ;
  args_info->debug_help = cluster_args_info_full_help[25] ;
  args_info->config_dir_help = cluster_args_info_full_help[26] ;
  args_info->master_node_help = cluster_args_info_full_help[28] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'X':	/* Force GC and expiration of reservations on all nodes.  */
          ...
          break;
        case 's':	/* Show current status of cluster nodes.  */
