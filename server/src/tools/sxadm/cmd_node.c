...
init_help_array(void)
{
  ...
  node_args_info_help[15] = node_args_info_full_help[19];
...
void init_args_info(struct node_args_info *args_info)
{
  ...
  args_info->cluster_key_help = node_args_info_full_help[13] ;
  args_info->batch_mode_help = node_args_info_full_help[14] ;
  args_info->cluster_uuid_help = node_args_info_full_help[15] ;
  args_info->human_readable_help = node_args_info_full_help[17] ;
  args_info->debug_help = node_args_info_full_help[18] ;
  args_info->owner_help = node_args_info_full_help[19] ;
