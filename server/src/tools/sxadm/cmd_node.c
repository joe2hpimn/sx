/*
  ...
  gengetopt -i cmd_node.ggo --unamed-opts --no-handle-version --no-handle-error --file-name=cmd_node --func-name=node_cmdline_parser --arg-struct-name=node_args_info
...
const char *node_args_info_full_help[] = {
  ...
  "  -I, --info                    Print details about the local node in\n                                  STORAGE_PATH",
  ...
  "      --compact                 Compact the node data freeing up any allocated\n                                  but unused storage space",
  "      --gc                      Run GC on node immediately",
  "      --gc-expire               Run GC on node and expire its reservations\n                                  immediately",
  "      --unbump-wait             Wait for active unbumps to complete",
  "      --warm-cache              Warm DB caches",
  "      --vacuum                  Vacuum",
  "      --get-definition          Print node definition in 'cluster --mod' format",
  "      --move-db=DBNAME=/new/path\n                                Move storage database to a different place",
  "\nNew node options:",
  "  -k, --cluster-key=FILE        File containing a pre-generated cluster\n                                  authentication token or stdin if \"-\" is\n                                  given (default autogenerate token).",
  "  -u, --cluster-uuid=UUID       The SX cluster UUID (default autogenerate\n                                  UUID).",
  "\nCommon options:",
  "  -b, --batch-mode              Turn off interactive confirmations, progress\n                                  notifications and assume yes for all\n                                  questions",
...
init_help_array(void)
{
  ...
  node_args_info_help[9] = node_args_info_full_help[17];
  node_args_info_help[10] = node_args_info_full_help[19];
  node_args_info_help[11] = node_args_info_full_help[20];
  node_args_info_help[12] = node_args_info_full_help[22];
  node_args_info_help[13] = node_args_info_full_help[23];
  node_args_info_help[14] = node_args_info_full_help[24];
  node_args_info_help[15] = node_args_info_full_help[25];
  node_args_info_help[16] = node_args_info_full_help[26];
  node_args_info_help[17] = 0; 
  
}

const char *node_args_info_help[18];
...
void clear_given (struct node_args_info *args_info)
{
  ...
  args_info->unbump_wait_given = 0 ;
  args_info->warm_cache_given = 0 ;
  args_info->vacuum_given = 0 ;
  args_info->get_definition_given = 0 ;
  args_info->move_db_given = 0 ;
...
void clear_args (struct node_args_info *args_info)
{
  ...
  args_info->move_db_arg = NULL;
  args_info->move_db_orig = NULL;
...
void init_args_info(struct node_args_info *args_info)
{
  ...
  args_info->unbump_wait_help = node_args_info_full_help[14] ;
  args_info->warm_cache_help = node_args_info_full_help[15] ;
  args_info->vacuum_help = node_args_info_full_help[16] ;
  args_info->get_definition_help = node_args_info_full_help[17] ;
  args_info->move_db_help = node_args_info_full_help[18] ;
  args_info->cluster_key_help = node_args_info_full_help[20] ;
  args_info->cluster_uuid_help = node_args_info_full_help[21] ;
  args_info->batch_mode_help = node_args_info_full_help[23] ;
  args_info->human_readable_help = node_args_info_full_help[24] ;
  args_info->debug_help = node_args_info_full_help[25] ;
  args_info->owner_help = node_args_info_full_help[26] ;
...
node_cmdline_parser_release (struct node_args_info *args_info)
{
  ...
  free_string_field (&(args_info->move_db_arg));
  free_string_field (&(args_info->move_db_orig));
...
node_cmdline_parser_dump(FILE *outfile, struct node_args_info *args_info)
{
  ...
  if (args_info->get_definition_given)
    write_into_file(outfile, "get-definition", 0, 0 );
  if (args_info->move_db_given)
    write_into_file(outfile, "move-db", args_info->move_db_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "gc",	0, NULL, 0 },
        { "gc-expire",	0, NULL, 0 },
        { "unbump-wait",	0, NULL, 0 },
        { "warm-cache",	0, NULL, 0 },
        { "vacuum",	0, NULL, 0 },
        { "get-definition",	0, NULL, 0 },
        { "move-db",	1, NULL, 0 },
      ...
      c = getopt_long (argc, argv, "hVNICE:k:u:bHD", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'u':	/* The SX cluster UUID (default autogenerate UUID)..  */
          ...
          break;
        case 'b':	/* Turn off interactive confirmations, progress notifications and assume yes for all questions.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Compact the node data freeing up any allocated but unused storage space.  */
          ...
          /* Run GC on node immediately.  */
          else if (strcmp (long_options[option_index].name, "gc") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->gc_given),
                &(local_args_info.gc_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "gc", '-',
                additional_error))
              goto failure;
          ...
          /* Run GC on node and expire its reservations immediately.  */
          else if (strcmp (long_options[option_index].name, "gc-expire") == 0)
          {
          ...
          /* Wait for active unbumps to complete.  */
          else if (strcmp (long_options[option_index].name, "unbump-wait") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->unbump_wait_given),
                &(local_args_info.unbump_wait_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "unbump-wait", '-',
                additional_error))
              goto failure;
          ...
          /* Print node definition in 'cluster --mod' format.  */
          else if (strcmp (long_options[option_index].name, "get-definition") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->get_definition_given),
                &(local_args_info.get_definition_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "get-definition", '-',
                additional_error))
              goto failure;
          ...
          /* Move storage database to a different place.  */
          else if (strcmp (long_options[option_index].name, "move-db") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->move_db_arg), 
                 &(args_info->move_db_orig), &(args_info->move_db_given),
                &(local_args_info.move_db_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "move-db", '-',
                additional_error))
              goto failure;
