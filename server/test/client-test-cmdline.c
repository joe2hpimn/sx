...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->replica_help = gengetopt_args_info_help[2] ;
  args_info->owner_help = gengetopt_args_info_help[3] ;
  args_info->human_help = gengetopt_args_info_help[4] ;
  args_info->debug_help = gengetopt_args_info_help[5] ;
  args_info->all_help = gengetopt_args_info_help[6] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vr:o:hDa", long_options, &option_index);
