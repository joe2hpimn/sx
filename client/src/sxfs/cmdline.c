...
const char *gengetopt_args_info_full_help[] = {
  ...
  "  -C, --cache-size=SIZE       Set size for local cache  (default=`512M')",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->cache_size_arg = gengetopt_strdup ("512M");
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->cache_dir_arg));
  free_string_field (&(args_info->cache_dir_orig));
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:R:l:o:qC:d:fDvsc:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'C':	/* Set size for local cache.  */
          ...
          break;
        case 'd':	/* Set directory for cache (sxfs tempdir by default).  */
        
        
          if (update_arg( (void *)&(args_info->cache_dir_arg), 
               &(args_info->cache_dir_orig), &(args_info->cache_dir_given),
              &(local_args_info.cache_dir_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "cache-dir", 'd',
              additional_error))
            goto failure;
