...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->list_help = gengetopt_args_info_full_help[4] ;
  args_info->info_help = gengetopt_args_info_full_help[5] ;
  args_info->delete_help = gengetopt_args_info_full_help[6] ;
  args_info->no_ssl_help = gengetopt_args_info_full_help[7] ;
  args_info->pass_file_help = gengetopt_args_info_full_help[8] ;
  args_info->port_help = gengetopt_args_info_full_help[9] ;
  args_info->host_list_help = gengetopt_args_info_full_help[10] ;
  args_info->alias_help = gengetopt_args_info_full_help[11] ;
  args_info->batch_mode_help = gengetopt_args_info_full_help[12] ;
  args_info->force_reinit_help = gengetopt_args_info_full_help[13] ;
  args_info->key_help = gengetopt_args_info_full_help[14] ;
  args_info->auth_file_help = gengetopt_args_info_full_help[15] ;
  args_info->debug_help = gengetopt_args_info_full_help[16] ;
