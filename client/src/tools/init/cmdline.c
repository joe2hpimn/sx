/*
  ...
  gengetopt -i sxinit.ggo --unamed-opts=sx://[profile@]cluster --no-handle-version --no-handle-error
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->no_ssl_help = gengetopt_args_info_full_help[4] ;
  args_info->auth_file_help = gengetopt_args_info_full_help[5] ;
  args_info->port_help = gengetopt_args_info_full_help[6] ;
  args_info->host_list_help = gengetopt_args_info_full_help[7] ;
  args_info->alias_help = gengetopt_args_info_full_help[8] ;
  args_info->batch_mode_help = gengetopt_args_info_full_help[9] ;
  args_info->force_reinit_help = gengetopt_args_info_full_help[10] ;
