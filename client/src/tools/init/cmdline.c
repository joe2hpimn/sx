/*
  ...
  gengetopt --unamed-opts=sx://[profile@]cluster --no-handle-version --no-handle-error
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->auth_file_help = gengetopt_args_info_full_help[8] ;
  ...
  args_info->config_dir_help = gengetopt_args_info_full_help[16] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVC:LIa:l:A:bkDc:", long_options, &option_index);
