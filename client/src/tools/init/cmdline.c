/*
  ...
  gengetopt -i client/src/tools/init/sxinit.ggo --output-dir=client/src/tools/init/ --unamed-opts=sx://[profile@]cluster --no-handle-version --no-handle-error --strict-hidden
...
const char *gengetopt_args_info_purpose = "Manage local configuration of SX";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -L, --list                    List configured clusters and aliases",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->alias_help = gengetopt_args_info_help[3] ;
  args_info->config_dir_help = gengetopt_args_info_help[4] ;
  args_info->host_list_help = gengetopt_args_info_help[5] ;
  args_info->no_ssl_help = gengetopt_args_info_help[6] ;
  args_info->debug_help = gengetopt_args_info_help[7] ;
  args_info->batch_mode_help = gengetopt_args_info_help[8] ;
  args_info->auth_file_help = gengetopt_args_info_help[9] ;
  args_info->force_reinit_help = gengetopt_args_info_help[10] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVLA:c:l:Dba:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'L':	/* List configured clusters and aliases.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "no-ssl") == 0)
          {
