...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->config_dir_help = gengetopt_args_info_help[3] ;
  args_info->host_list_help = gengetopt_args_info_help[4] ;
  args_info->no_ssl_help = gengetopt_args_info_help[5] ;
  args_info->debug_help = gengetopt_args_info_help[6] ;
  args_info->batch_mode_help = gengetopt_args_info_help[7] ;
  args_info->auth_file_help = gengetopt_args_info_help[8] ;
  args_info->force_reinit_help = gengetopt_args_info_help[9] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVLc:l:Dba:", long_options, &option_index);
