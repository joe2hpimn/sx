/*
  ...
  gengetopt -i sxinit.ggo --unamed-opts=sx://[profile@]cluster --no-handle-version --no-handle-error --strict-hidden
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->batch_mode_help = gengetopt_args_info_help[9] ;
  args_info->auth_file_help = gengetopt_args_info_help[10] ;
  args_info->force_reinit_help = gengetopt_args_info_help[11] ;
