...
const char *gengetopt_args_info_purpose = "Concatenate and print files";

const char *gengetopt_args_info_usage = "Usage: sxcat [OPTIONS]... sx://[profile@]cluster/volume/[path]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "sxcat allows printing files both from and to SX nodes";
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[3] = gengetopt_args_info_full_help[5];
  gengetopt_args_info_help[4] = 0; 
  
}

const char *gengetopt_args_info_help[5];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->filter_dir_help = gengetopt_args_info_full_help[4] ;
