...
const char *gengetopt_args_info_purpose = "Move between SX volumes and clusters";

const char *gengetopt_args_info_usage = "Usage: sxmv [OPTIONS]... SOURCE... DEST";
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVrDc:f:", long_options, &option_index);
