/*
  ...
  gengetopt -i client/src/tools/ls/sxls.ggo --output-dir=client/src/tools/ls/ --unamed-opts --no-handle-version --no-handle-error
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->config_dir_help = gengetopt_args_info_full_help[3] ;
  args_info->recursive_help = gengetopt_args_info_full_help[4] ;
  args_info->long_format_help = gengetopt_args_info_full_help[5] ;
  args_info->human_readable_help = gengetopt_args_info_full_help[6] ;
  args_info->filter_dir_help = gengetopt_args_info_full_help[7] ;
  args_info->debug_help = gengetopt_args_info_full_help[8] ;
  args_info->verbose_help = gengetopt_args_info_full_help[9] ;
