...
const char *gengetopt_args_info_full_help[] = {
  ...
  "      --etag=ETAGFILE    Retrieve only modified volume listing",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->etag_arg = NULL;
  args_info->etag_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->long_format_help = gengetopt_args_info_full_help[4] ;
  ...
  args_info->etag_help = gengetopt_args_info_full_help[11] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->etag_arg));
  free_string_field (&(args_info->etag_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->long_format_given)
  ...
  if (args_info->etag_given)
    write_into_file(outfile, "etag", args_info->etag_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVrlHDvc:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'r':	/* Recursively list entire directories.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Retrieve only modified volume listing.  */
          else if (strcmp (long_options[option_index].name, "etag") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->etag_arg), 
                 &(args_info->etag_orig), &(args_info->etag_given),
                &(local_args_info.etag_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "etag", '-',
                additional_error))
              goto failure;
