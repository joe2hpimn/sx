/*
  ...
  gengetopt -i cmd_main.ggo --no-handle-version --no-handle-error --file-name=cmd_main --func-name=main_cmdline_parser --arg-struct-name=main_args_info
...
const char *main_args_info_purpose = "Manage file revisions on SX volumes";

const char *main_args_info_usage = "Usage: sxrev <command> OPTIONS";
...
const char *main_args_info_help[] = {
  ...
  "\nAvailable commands:\n\n  lis         List the revision of a file\n  copy        Copy the a specific revision of a file\n  delete      Deletes a specific revision of a file\n\nSee 'sxrev <command> --help' for more information on a specific command.\n",
    0
};
