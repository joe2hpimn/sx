...
const char *gengetopt_args_info_purpose = "Remove files from SX volumes";

const char *gengetopt_args_info_usage = "Usage: sxrm [OPTIONS]... sx://[profile@]cluster/volume/[path]...";
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVc:rDv", long_options, &option_index);
