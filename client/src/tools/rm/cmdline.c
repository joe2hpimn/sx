/*
  ...
  gengetopt -i client/src/tools/rm/sxrm.ggo --output-dir client/src/tools/rm/ --unamed-opts --no-handle-version --no-handle-error
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'r':	/* Recursively remove entire directories.  */
