/*
  ...
  gengetopt -i client/src/tools/cp/sxcp.ggo --output-dir=client/src/tools/cp/ --unamed-opts --no-handle-version --no-handle-error --strict-hidden
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -r, --recursive        Recursively copy files from SOURCE to DEST directory\n                           (default=off)",
  "  -v, --verbose          Print more details about the upload  (default=off)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->recursive_help = gengetopt_args_info_help[2] ;
  args_info->verbose_help = gengetopt_args_info_help[3] ;
  args_info->config_dir_help = gengetopt_args_info_help[4] ;
