/*
  ...
  gengetopt -i sxcp.ggo --unamed-opts --no-handle-version --no-handle-error
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[11] = gengetopt_args_info_full_help[16];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->exclude_help = gengetopt_args_info_full_help[15] ;
  args_info->exclude_min = 0;
  args_info->exclude_max = 0;
  args_info->include_help = gengetopt_args_info_full_help[16] ;
