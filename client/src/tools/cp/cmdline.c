/*
  ...
  gengetopt --unamed-opts --no-handle-version --no-handle-error
...
const char *gengetopt_args_info_purpose = "Copy files between local and SX storages";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->one_file_system_help = gengetopt_args_info_full_help[8] ;
  args_info->debug_help = gengetopt_args_info_full_help[9] ;
  args_info->no_progress_help = gengetopt_args_info_full_help[10] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVrvc:f:b:xDqs:", long_options, &option_index);
