...
#ifndef CREATE_CMDLINE_PARSER_PACKAGE
/** @brief the program name (used for printing errors) */
#define CREATE_CMDLINE_PARSER_PACKAGE "sxvol"
#endif

#ifndef CREATE_CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CREATE_CMDLINE_PARSER_PACKAGE_NAME "sxvol"
#endif

#ifndef CREATE_CMDLINE_PARSER_VERSION
/** @brief the program version */
#define CREATE_CMDLINE_PARSER_VERSION VERSION
#endif
...
struct create_cmdline_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure create_args_info (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure create_args_info (default 0) */
  int print_errors; /**< @brief whether getopt_long should print an error message for a bad option (default 1) */
} ;

/** @brief the purpose string of the program */
extern const char *create_args_info_purpose;
/** @brief the usage string of the program */
extern const char *create_args_info_usage;
 ...
 */
int create_cmdline_parser (int argc, char **argv,
  struct create_args_info *args_info);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 * @deprecated use create_cmdline_parser_ext() instead
 */
int create_cmdline_parser2 (int argc, char **argv,
  struct create_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int create_cmdline_parser_ext (int argc, char **argv,
  struct create_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int create_cmdline_parser_dump(FILE *outfile,
  struct create_args_info *args_info);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int create_cmdline_parser_file_save(const char *filename,
  struct create_args_info *args_info);
 ...
 * Print the version
 */
void create_cmdline_parser_print_version(void);

/**
 * Initializes all the fields a create_cmdline_parser_params structure 
 * to their default values
 * @param params the structure to initialize
 */
void create_cmdline_parser_params_init(struct create_cmdline_parser_params *params);

/**
 * Allocates dynamically a create_cmdline_parser_params structure and initializes
 * all its fields to their default values
 * @return the created and initialized create_cmdline_parser_params structure
 */
struct create_cmdline_parser_params *create_cmdline_parser_params_create(void);

/**
 * Initializes the passed create_args_info structure's fields
 * (also set default values for options that have a default)
 * @param args_info the structure to initialize
 */
void create_cmdline_parser_init (struct create_args_info *args_info);
/**
 * Deallocates the string fields of the create_args_info structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void create_cmdline_parser_free (struct create_args_info *args_info);
 ...
 * @return
 */
int create_cmdline_parser_required (struct create_args_info *args_info,
