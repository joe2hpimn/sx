/*
  ...
  gengetopt --unamed-opts --no-handle-version --no-handle-error --file-name=cmd_create --func-name=create_cmdline_parser --arg-struct-name=create_args_info --strict-hidden
...
const char *create_args_info_help[] = {
