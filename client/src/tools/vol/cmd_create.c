/*
  ...
  gengetopt -i cmd_create.ggo --unamed-opts --no-handle-version --no-handle-error --file-name=cmd_create --func-name=create_cmdline_parser --arg-struct-name=create_args_info
...
init_help_array(void)
{
  ...
  create_args_info_help[10] = create_args_info_full_help[10];
  create_args_info_help[11] = 0; 
  
}

const char *create_args_info_help[12];
...
void init_args_info(struct create_args_info *args_info)
{
  ...
  args_info->filter_dir_help = create_args_info_full_help[12] ;
