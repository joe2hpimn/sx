...
const char *modify_args_info_full_help[] = {
  ...
  "  -r, --replica=INT         Change the volume replica",
...
init_help_array(void)
{
  ...
  modify_args_info_help[11] = modify_args_info_full_help[11];
  modify_args_info_help[12] = modify_args_info_full_help[14];
  modify_args_info_help[13] = 0; 
  
}

const char *modify_args_info_help[14];
...
void init_args_info(struct modify_args_info *args_info)
{
  ...
  args_info->replica_help = modify_args_info_full_help[4] ;
  args_info->owner_help = modify_args_info_full_help[5] ;
  args_info->size_help = modify_args_info_full_help[6] ;
  args_info->max_revisions_help = modify_args_info_full_help[7] ;
  args_info->reset_custom_meta_help = modify_args_info_full_help[8] ;
  args_info->reset_local_config_help = modify_args_info_full_help[10] ;
  args_info->debug_help = modify_args_info_full_help[11] ;
  args_info->config_dir_help = modify_args_info_full_help[12] ;
  args_info->filter_dir_help = modify_args_info_full_help[13] ;
  args_info->batch_mode_help = modify_args_info_full_help[14] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVr:o:s:m:Dc:b", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'r':	/* Change the volume replica.  */
        ...
        case 's':	/* Set a new size of the volume (allows K,M,G,T suffixes).  */
          ...
          break;
        case 'm':	/* Set a new revisions limit for files in the volume.  */
        
        
          if (update_arg( (void *)&(args_info->max_revisions_arg), 
               &(args_info->max_revisions_orig), &(args_info->max_revisions_given),
              &(local_args_info.max_revisions_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "max-revisions", 'm',
              additional_error))
            goto failure;
