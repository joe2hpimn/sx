/*
  ...
  gengetopt --unamed-opts --no-handle-version --no-handle-error --file-name=cmd_modify --func-name=modify_cmdline_parser --arg-struct-name=modify_args_info
...
const char *modify_args_info_full_help[] = {
  ...
  "  -o, --owner=NAME          Grant full privileges to the new owner NAME, and\n                              revoke all privileges for previous owner",
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVo:s:m:Dc:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'o':	/* Grant full privileges to the new owner NAME, and revoke all privileges for previous owner.  */
