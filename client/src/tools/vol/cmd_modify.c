/*
  ...
  gengetopt -i client/src/tools/vol/cmd_modify.ggo --output-dir client/src/tools/vol/ --unamed-opts --no-handle-version --no-handle-error --file-name=cmd_modify --func-name=modify_cmdline_parser --arg-struct-name=modify_args_info
...
const char *modify_args_info_full_help[] = {
  ...
  "  -r, --max-revisions=INT  Set a new revisions limit for files in the volume",
  "\nAdditional options:\n",
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "owner",	1, NULL, 'o' },
        { "size",	1, NULL, 's' },
        { "max-revisions",	1, NULL, 'r' },
        { "debug",	0, NULL, 'D' },
        { "config-dir",	1, NULL, 'c' },
        { 0,  0, 0, 0 }
      };

      c = getopt_long (argc, argv, "hVo:s:r:Dc:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 's':	/* Set a new size of the volume (allows K,M,G,T suffixes).  */
          ...
          break;
        case 'r':	/* Set a new revisions limit for files in the volume.  */
