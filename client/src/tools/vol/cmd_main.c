/*
  ...
  gengetopt -i client/src/tools/vol/cmd_main.ggo --output-dir client/src/tools/vol/ --no-handle-version --no-handle-error --file-name=cmd_main --func-name=main_cmdline_parser --arg-struct-name=main_args_info
