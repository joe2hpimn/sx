/*
  ...
  gengetopt --no-handle-version --no-handle-error --no-handle-help --file-name=cmd_main --func-name=main_cmdline_parser --arg-struct-name=main_args_info
