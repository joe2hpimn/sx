/*
  ...
  gengetopt -i client/src/tools/acl/cmd_main.ggo --output-dir client/src/tools/acl/ --no-handle-version --no-handle-error --no-handle-help --file-name=cmd_main --func-name=main_cmdline_parser --arg-struct-name=main_args_info
...
const char *main_args_info_purpose = "Manage SX users and their permissions";

const char *main_args_info_usage = "Usage: sxacl <command> [OPTIONS]...";
