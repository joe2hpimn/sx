/*
  ...
  gengetopt --unamed-opts --no-handle-version --no-handle-error --file-name=cmd_usergetkey --func-name=usergetkey_cmdline_parser --arg-struct-name=usergetkey_args_info --strict-hidden
...
const char *usergetkey_args_info_versiontext = "";

const char *usergetkey_args_info_description = "";

const char *usergetkey_args_info_help[] = {
...
void init_args_info(struct usergetkey_args_info *args_info)
{
  ...
  args_info->help_help = usergetkey_args_info_help[0] ;
  args_info->version_help = usergetkey_args_info_help[1] ;
  args_info->auth_file_help = usergetkey_args_info_help[3] ;
  args_info->config_dir_help = usergetkey_args_info_help[5] ;
  args_info->debug_help = usergetkey_args_info_help[6] ;
...
usergetkey_cmdline_parser_print_version (void)
{
  ...
  if (strlen(usergetkey_args_info_versiontext) > 0)
    printf("\n%s\n", usergetkey_args_info_versiontext);
}
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVa:c:D", long_options, &option_index);
