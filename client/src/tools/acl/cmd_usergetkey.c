/*
  ...
  ggo --unamed-opts --no-handle-version --no-handle-error --file-name=cmd_usergetkey --func-name=usergetkey_cmdline_parser --arg-struct-name=usergetkey_args_info
...
init_help_array(void)
{
  ...
  usergetkey_args_info_help[6] = usergetkey_args_info_full_help[7];
  usergetkey_args_info_help[7] = 0; 
  
}

const char *usergetkey_args_info_help[8];
...
void init_args_info(struct usergetkey_args_info *args_info)
{
  ...
  args_info->config_dir_help = usergetkey_args_info_full_help[6] ;
  args_info->debug_help = usergetkey_args_info_full_help[7] ;
