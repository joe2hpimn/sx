  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVo:c:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'o':	/* Save output to given file (default: sxreport-client-<timestamp>.log).  */
