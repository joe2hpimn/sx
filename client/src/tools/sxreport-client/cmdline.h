...
#define CMDLINE_PARSER_PACKAGE "sxreport-client"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "sxreport-client"
#endif
...
struct gengetopt_args_info
{
  ...
  const char *output_help; /**< @brief Save output to given file (default: sxreport-client-<timestamp>.log) help description.  */
