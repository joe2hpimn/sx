...
Path to SX storage [default=/var/lib/sxserver]: ^\marked{<confirm default>}^
...
List of nodes:
         * ec4d9d63-9fa3-4d45-838d-3e521f124ed3 192.168.1.101 (192.168.1.101) 500.00G
Storage location: /var/lib/sxserver
Run as user: nobody
...
\begin{itemize}
    ...
    \item Run \path{sxsetup} and provide the collected information.
	  Below we assume the new node is 192.168.1.102 and its size is 250 GBs.
\end{itemize}
...
If you don't have it, run \path{sxsetup --info} on 192.168.1.101.
...
with the IP address of 192.168.1.103 and size of 250G, which has the SX
